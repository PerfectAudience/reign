...
public class DefaultPathSchemeTest {
    ...
    @Test
    public void testIsValidPathToken() throws Exception {
        assertTrue(pathScheme.isValidToken("jack"));
        assertTrue(pathScheme.isValidToken("jack/jill"));
        assertTrue(pathScheme.isValidToken("jack/jill/up/the"));
        assertTrue(pathScheme.isValidToken("jack/jill/up/the/hill"));

        assertFalse(pathScheme.isValidToken("/jack"));
        assertFalse(pathScheme.isValidToken("jack/jill/"));
        assertFalse(pathScheme.isValidToken("/jack/jill/up/the"));
        assertFalse(pathScheme.isValidToken("jack/jill/up/the/hill/"));
    }
