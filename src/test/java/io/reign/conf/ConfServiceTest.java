...
public class ConfServiceTest {
    ...
    public void testPutConfAndGetConf() {
        ...
        Properties props2 = confService.getConf("clusterA", "test1.properties");
    ...
    public void testObserver() throws Exception {
        ...
        confService.observe("clusterA", "test2.properties", new ConfObserver<Properties>() {
            @Override
            public void updated(Properties updated, Properties existing) {
