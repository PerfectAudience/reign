 ...
 */
public abstract class NodeObserverWrapper<T extends NodeObserver> {

    /** cannot be null */
    protected T observer;

    protected CanonicalId canonicalId;
    ...
    public boolean equals(Object o) {
        if (o == null || !(o instanceof NodeObserverWrapper)) {
            return false;
        }
        return this.observer == ((NodeObserverWrapper) o).getObserver();
    }
