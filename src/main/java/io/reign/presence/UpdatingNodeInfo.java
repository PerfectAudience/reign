...
public class UpdatingNodeInfo implements NodeInfo {
    ...
    public UpdatingNodeInfo(String clusterId, String serviceId, NodeId nodeId, ReignContext context) {
        ...
        nodeInfo = presenceService.getNodeInfo(clusterId, serviceId, context.getPathScheme().toPathToken(nodeId),
                observer);
    }
